...
Temperatures appear to be increasing, please increase air conditioning a little in the summer and decrease heating a little in the winter.
...
Temperatures appear to be decreasing, please decrease air conditioning a little in the summer and increase heating a little in the winter.
Please forward pictures of temperature setting changes in the next two hours, to keep your guarantee active.
Please keep monitoring temperatures and adjusting throughout the day.
...
Temperatures appear to be increasing suddenly, please increase air conditioning a little in the summer and decrease heating a little in the winter.
Please forward pictures of temperature setting changes in the next two hours, to keep your guarantee active.
Please keep monitoring temperatures and adjusting throughout the day.
...
Temperatures appear to be decreasing suddenly, please decrease air conditioning a little in the summer and increase heating a little in the winter.
Please forward pictures of temperature setting changes in the next two hours, to keep your guarantee active.
Please keep monitoring temperatures and adjusting throughout the day.
...
export function messageTypeForAlert(alertType: string): 'alert' | 'daily_summary' {
  return alertType === 'sudden_fluctuation' ? 'alert' : 'daily_summary';
}

export function emailSubjectForTemplate(templateType: MessageTemplateType): string {
  switch (templateType) {
    case 'alert_increase':
    case 'alert_decrease':
