...
export default function StaffSignupPage() {
  ...
  const [editForm, setEditForm] = useState({ email: "", name: "", phone: "", is_active: true });
  ...
  const handleDeleteClick = (u: StaffUser) => {
    setDeleteTarget(u);
  };
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="fixed z-50 inset-0 overflow-y-auto" aria-modal="true">
          <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            <div
              className="fixed inset-0 bg-gray-600 bg-opacity-75 transition-opacity"
              aria-hidden="true"
              onClick={() => !updateLoading && setEditingStaff(null)}
            />
            <span className="hidden sm:inline-block sm:align-middle sm:h-screen" aria-hidden="true">
              &#8203;
            </span>
      ...
      <ConfirmModal
        ...
        title="Delete staff"
        message="Are you sure you want to delete this staff user? This cannot be undone."
        confirmLabel="Delete"
        cancelLabel="Cancel"
        variant="danger"
